...
GraphConfig = (
    ...
    ('dns_rrl_server_stats',
     dict(title='BIND_DNS [04] RRL Server Stats',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Queries/sec',
          location="server/counters[@type='nsstat']/counter",
          fields=("RateDropped", "RateSlipped"),
          config=dict(type='DERIVE', min=0))),

    ('dns_rpz_server_stats',
     dict(title='BIND_DNS [05] RPZ Server Stats',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Queries/sec',
    ...
    ('dns_cachedb',
     dict(title='BIND_DNS [06] CacheDB RRsets',
          enable=True,
          stattype='cachedb',
          args='-l 0',
          vlabel='Count/sec',
    ...
    ('dns_resolver_stats_qtype',
     dict(title='BIND_DNS [07] Resolver Outgoing Queries',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Count/sec',
    ...
    ('dns_resolver_stats_view',
     dict(title='BIND_DNS [08] Resolver Stats',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Count/sec',
          fields=("NXDOMAIN", "SERVFAIL", "FORMERR", "OtherError", "EDNS0Fail",
                  "Mismatch", "Truncated", "Lame", "Retry", "QueryAbort",
                  "QuerySockFail", "QueryCurUDP", "QueryCurTCP", "QueryTimeout",
                  "GlueFetchv4", "GlueFetchv6", "GlueFetchv4Fail", "GlueFetchv6Fail",
                  "NumFetch", "BucketSize", "REFUSED", "ClientCookieOut",
                  "ServerCookieOut", "CookieIn", "CookieClientOk", 
                  "BadEDNSVersion", "BadCookieRcode", "ZoneQuota", "ServerQuota",
                  "NextItem"),
    ...
    ('dns_resolver_ip_stats_view',
     dict(title='BIND_DNS [09] IP Resolver Stats',
          ...
          args='-l 0',
          vlabel='Count/sec',
          fields=("Queryv4", "Queryv6", "Responsev4", "Responsev6"),
          location="views/view[@name='default']/counters[@type='resstats']/counter",
          config=dict(type='DERIVE', min=0))),

    ('dns_resolver_val_stats_view',
     dict(title='BIND_DNS [10] Validation Resolver Stats',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Count/sec',
          fields=("ValAttempt", "ValOk", "ValNegOk", "ValFail"),
          location="views/view[@name='default']/counters[@type='resstats']/counter",
          config=dict(type='DERIVE', min=0))),

    ('dns_resolver_rtt_stats_view',
     dict(title='BIND_DNS [11] RTT Resolver Stats',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Count/sec',
          fields=("QryRTT10", "QryRTT100", "QryRTT500", "QryRTT800", "QryRTT1600",
                  "QryRTT1600+"),
          location="views/view[@name='default']/counters[@type='resstats']/counter",
          config=dict(type='DERIVE', min=0, draw='AREASTACK'))),

    ('dns_cachestats',
     dict(title='BIND_DNS [12] Resolver Cache Stats',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Count/sec',
    ...
    ('dns_socket_stats',
     dict(title='BIND_DNS [13] Socket Stats',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Count/sec',
    ...
    ('dns_zone_stats',
     dict(title='BIND_DNS [14] Zone Maintenance',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Count/sec',
    ...
    ('dns_memory_usage',
     dict(title='BIND_DNS [15] Memory Usage',
          enable=True,
          stattype='memory',
          args='-l 0 --base 1024',
    ...
    ('dns_adbstat',
     dict(title='BIND_DNS [16] adbstat',
          enable=True,
          stattype='counter',
          args='-l 0',
          vlabel='Count/sec',
